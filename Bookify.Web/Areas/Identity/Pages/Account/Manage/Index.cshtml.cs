...
namespace LibraryManagementSystem.Areas.Identity.Pages.Account.Manage
{
	public class IndexModel : PageModel
	{
		...
		public class InputModel
		{
			...
			[Required, MaxLength(100, ErrorMessage = ValidationMessages.MaxLength), Display(Name = "Full Name"),
			RegularExpression(RegexPatterns.CharactersOnly_Eng, ErrorMessage = ValidationMessages.OnlyEnglishLetters)]
			public string FullName { get; set; } = null!;

			[Phone]
			[Display(Name = "Phone number"), MaxLength(11, ErrorMessage = ValidationMessages.MaxLength),
